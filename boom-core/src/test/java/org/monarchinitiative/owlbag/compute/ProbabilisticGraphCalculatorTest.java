...
public class ProbabilisticGraphCalculatorTest {
	...
	/* Manually generate curieMap for running unittests (only) */
	@BeforeClass
	public static void serializeTestCurieMap() throws IOException {
		Map<String, String> curieMap = HashBiMap.create();
		curieMap.put("X", "http://purl.obolibrary.org/obo/X_");
		curieMap.put("Y", "http://purl.obolibrary.org/obo/Y_");
		curieMap.put("Z", "http://purl.obolibrary.org/obo/Z_");
		curieMap.put("OMIM", "http://purl.obolibrary.org/obo/OMIM_");
		curieMap.put("DOID", "http://purl.obolibrary.org/obo/DOID_");
		curieMap.put("MESH", "http://purl.obolibrary.org/obo/MESH_");
		curieMap.put("Orphanet", "http://purl.obolibrary.org/obo/Orphanet_");

		String tempDir = System.getProperty("java.io.tmpdir");
		String curieMapSerFile = tempDir + File.separatorChar + "curiemap.ser";
	...
	@AfterClass
	public static void removeTestCurieMap() throws IOException {
		String tempDir = System.getProperty("java.io.tmpdir");
		String curieMapSerFile = tempDir + File.separatorChar + "curiemap.ser";
		FileUtils.deleteQuietly(new File(curieMapSerFile));
	}
